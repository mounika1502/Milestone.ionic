...
fetch("https://earmuffs-ox.cyclic.app/orderRoute/getAllOrders", {
      method:"get",
      headers:{
...
this.count=this.order.length;
 ...
 Shipped(){   
  ...
  fetch("https://earmuffs-ox.cyclic.app/orderRoute/orderupdate", {
    method:'post',
    headers:{
    "Access-Control-Allow-Origin": "*",
...
Update(){
  ...
  fetch("https://earmuffs-ox.cyclic.app/orderRoute/orderStatus",{
    method:"POST",
    headers:{
      "access-Control-Allow-Origin":"*",
      "Content-Type":'application/json'
